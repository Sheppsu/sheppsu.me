...
function createTournamentElements(data) {
    ...
    for (const item of[["Host", data.hosted], ["Co-Host", data.cohost], ["Admin", data.admin], ["Sheeter", data.sheeted], ["Streamer", data.streamed], ["Mappooler", data.mappooled], ["Playtester", data.playtested], ["Referee", data.reffed]]) {
